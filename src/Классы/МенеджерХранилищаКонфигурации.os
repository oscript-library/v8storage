...
Процедура ПриСозданииОбъекта(Знач НовыйКаталогХранилища = Неопределено, НовыйУправлениеКонфигуратором = Неопределено)
    ...
    Если Не НовыйКаталогХранилища = Неопределено Тогда
        УстановитьКаталогХранилища(НовыйКаталогХранилища);
    КонецЕсли;
